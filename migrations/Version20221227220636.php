 ...
 */
final class Version20221227220636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE about ADD COLUMN address CLOB DEFAULT NULL');
        $this->addSql('ALTER TABLE about ADD COLUMN email VARCHAR(180) NOT NULL');
        $this->addSql('ALTER TABLE about ADD COLUMN opening_ours CLOB NOT NULL');
    }
